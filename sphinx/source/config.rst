...
.. var:: config.save_json_callbacks = [ ... ]
    ...
    The value of the ``playername`` variable at the moment the game was saved
...
.. var:: config.new_substitutions = True
    ...
    If True, Ren'Py will apply new-style (square-bracket) substitutions 
    to all text displayed.
...
.. var:: config.save_persistent = True
    ...
    If True, Ren'Py will save persistent data. If False, persistent data will 
    not be saved, and changes to persistent will be lost when the game ends.
